...
import com.nafhan.myapplication.databinding.FragmentProfileBinding
...
class ProfileFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        with(binding){
            ...
            editor?.apply()
            txtUserName.text = sharedPref?.getString("name", "Tidak ada nama")
            txtUserTabungan.text = "${sharedPref?.getString("rekening", "Tidak ada rekening")}"
        }
        return binding.root
    }
